...
func (SpeakerInfo) Descriptor() protoreflect.EnumDescriptor {
	return file_protoc_schema_proto_enumTypes[0].Descriptor()
}

func (SpeakerInfo) Type() protoreflect.EnumType {
	return &file_protoc_schema_proto_enumTypes[0]
}
...
func (SpeakerInfo) EnumDescriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{0}
}
...
const (
	...
	TtsErr_TTS_ERR_NET_ERR              TtsErr = 10008 //网络异常
	TtsErr_TTS_ERR_NO_FREE_MOUDLE       TtsErr = 10009 //没有可用的模型
	//TTS_ERR_LAST_TEXT_RUNNING = 10010;//上一条文本尚未合成完毕
...
var (
	TtsErr_name = map[int32]string{
		...
		10008: "TTS_ERR_NET_ERR",
		10009: "TTS_ERR_NO_FREE_MOUDLE",
	...
	TtsErr_value = map[string]int32{
		...
		"TTS_ERR_NET_ERR":              10008,
		"TTS_ERR_NO_FREE_MOUDLE":       10009,
...
func (TtsErr) Descriptor() protoreflect.EnumDescriptor {
	return file_protoc_schema_proto_enumTypes[1].Descriptor()
}

func (TtsErr) Type() protoreflect.EnumType {
	return &file_protoc_schema_proto_enumTypes[1]
}
...
func (TtsErr) EnumDescriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{1}
}
...
func (PcmStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_protoc_schema_proto_enumTypes[2].Descriptor()
}

func (PcmStatus) Type() protoreflect.EnumType {
	return &file_protoc_schema_proto_enumTypes[2]
}
...
func (PcmStatus) EnumDescriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{2}
}
...
func (x *TtsReq) Reset() {
	*x = TtsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[0]
...
type TtsRes struct {
	...
	//当前正在合成的正则后的文本片段
	NormalizedText string `protobuf:"bytes,7,opt,name=NormalizedText,proto3" json:"NormalizedText,omitempty"`
	//当前正在合成的正则前的文本片段(端侧需要的)
	OriginalText string `protobuf:"bytes,8,opt,name=originalText,proto3" json:"originalText,omitempty"`
	//表情的具体数据
	Expression *Expression `protobuf:"bytes,9,opt,name=expression,proto3" json:"expression,omitempty"`
}

func (x *TtsRes) Reset() {
	*x = TtsRes{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Expression) Reset() {
	*x = Expression{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *VerReq) Reset() {
	*x = VerReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerReq) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{3}
}
...
func (x *VerRsp) Reset() {
	*x = VerRsp{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VerRsp) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{4}
}
...
func (x *TimedMouthShape) Reset() {
	*x = TimedMouthShape{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TimedMouthShape) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{5}
}
...
func (x *MixTtsReq) Reset() {
	*x = MixTtsReq{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*MixTtsReq) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{6}
}
...
type SpeakerList struct {
	...
	//发音人列表
	List []*SpeakerParameter `protobuf:"bytes,1,rep,name=list,proto3" json:"list,omitempty"`
}

func (x *SpeakerList) Reset() {
	*x = SpeakerList{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SpeakerList) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{7}
}
...
type SpeakerParameter struct {
	...
	//发音人id
	SpeakerId int32 `protobuf:"varint,1,opt,name=speakerId,proto3" json:"speakerId,omitempty"`
	//发音人名字
	SpeakerName string `protobuf:"bytes,2,opt,name=speakerName,proto3" json:"speakerName,omitempty"`
	//发音人英文名字
	ParameterSpeakerName string `protobuf:"bytes,3,opt,name=parameterSpeakerName,proto3" json:"parameterSpeakerName,omitempty"`
}

func (x *SpeakerParameter) Reset() {
	*x = SpeakerParameter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_protoc_schema_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SpeakerParameter) Descriptor() ([]byte, []int) {
	return file_protoc_schema_proto_rawDescGZIP(), []int{8}
}
...
var File_protoc_schema_proto protoreflect.FileDescriptor

var file_protoc_schema_proto_rawDesc = []byte{
	0x0a, 0x13, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x2f, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x61, 0x22, 0xfb, 0x02,
	0x0a, 0x06, 0x54, 0x74, 0x73, 0x52, 0x65, 0x71, 0x12, 0x1a, 0x0a, 0x08, 0x6c, 0x6f, 0x63, 0x61,
	...
	,
	...
	,
}

var (
	file_protoc_schema_proto_rawDescOnce sync.Once
	file_protoc_schema_proto_rawDescData = file_protoc_schema_proto_rawDesc
)

func file_protoc_schema_proto_rawDescGZIP() []byte {
	file_protoc_schema_proto_rawDescOnce.Do(func() {
		file_protoc_schema_proto_rawDescData = protoimpl.X.CompressGZIP(file_protoc_schema_proto_rawDescData)
	})
	return file_protoc_schema_proto_rawDescData
}

var file_protoc_schema_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_protoc_schema_proto_msgTypes = make([]protoimpl.MessageInfo, 9)
var file_protoc_schema_proto_goTypes = []interface{}{
...
var file_protoc_schema_proto_depIdxs = []int32{
...
func init() { file_protoc_schema_proto_init() }
func file_protoc_schema_proto_init() {
	if File_protoc_schema_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_protoc_schema_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TtsReq); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_schema_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TtsRes); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_schema_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoc_schema_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerReq); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_schema_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*VerRsp); i {
			case 0:
				return &v.state
			case 1:
		...
		file_protoc_schema_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoc_schema_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoc_schema_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protoc_schema_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_protoc_schema_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_protoc_schema_proto_goTypes,
		DependencyIndexes: file_protoc_schema_proto_depIdxs,
		EnumInfos:         file_protoc_schema_proto_enumTypes,
		MessageInfos:      file_protoc_schema_proto_msgTypes,
	}.Build()
	File_protoc_schema_proto = out.File
	file_protoc_schema_proto_rawDesc = nil
	file_protoc_schema_proto_goTypes = nil
	file_protoc_schema_proto_depIdxs = nil
}
...
func (c *cloudMindsTTSClient) Call(ctx context.Context, in *TtsReq, opts ...grpc.CallOption) (CloudMindsTTS_CallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CloudMindsTTS_serviceDesc.Streams[0], "/schema.CloudMindsTTS/Call", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *cloudMindsTTSClient) MixCall(ctx context.Context, in *MixTtsReq, opts ...grpc.CallOption) (CloudMindsTTS_MixCallClient, error) {
	stream, err := c.cc.NewStream(ctx, &_CloudMindsTTS_serviceDesc.Streams[1], "/schema.CloudMindsTTS/MixCall", opts...)
	if err != nil {
		return nil, err
	}
...
// UnimplementedCloudMindsTTSServer can be embedded to have forward compatible implementations.
...
func RegisterCloudMindsTTSServer(s *grpc.Server, srv CloudMindsTTSServer) {
	s.RegisterService(&_CloudMindsTTS_serviceDesc, srv)
}
...
var _CloudMindsTTS_serviceDesc = grpc.ServiceDesc{
